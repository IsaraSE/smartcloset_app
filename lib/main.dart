...
final kProducts = <Product>[
  Product(
    ...
    images: ['$_u/photo-1598033129183-c4f50c736f10?w=800&q=80', '$_u/photo-1596755094514-f87e34085b2c?w=800&q=80', '$_u/photo-1588359348347-9bc6cbbb689e?w=800&q=80'],
  ...
  Product(
    ...
    description: 'Elevate your wardrobe with this sophisticated wool-blend blazer. Features a single-button closure, notch lapels, and structured shoulders. The slim silhouette creates a sharp, professional look that transitions seamlessly from office to evening events.',
    price: 249.99, originalPrice: 380.00, category: 'Men', subCategory: 'Formal',
    images: ['$_u/photo-1507679799987-c73779587ccf?w=800&q=80', '$_u/photo-1617127365659-c47fa864d8bc?w=800&q=80'],
  ...
  Product(
    ...
    description: 'Versatile chino trousers that seamlessly blend comfort and style. Crafted from a lightweight cotton-stretch blend with a clean, tailored silhouette. Features a flat front, four-pocket design, and subtle texture for smart everyday wear.',
    price: 89.99, category: 'Men', subCategory: 'Casual',
    images: ['$_u/photo-1624378439575-d8705ad7ae80?w=800&q=80', '$_u/photo-1473966968600-fa801b869a1a?w=800&q=80'],
  ...
  Product(
    ...
    description: 'The ultimate streetwear staple. This heavyweight cotton hoodie features an oversized silhouette, kangaroo pocket, and ribbed cuffs. The premium fleece interior provides exceptional warmth and comfort. A true wardrobe essential.',
  ...
  Product(
    ...
    description: 'Functional meets fashion with these technical cargo pants. Multiple zip pockets, adjustable waistband, and a tapered leg silhouette. Made from water-resistant ripstop fabric that handles whatever the city throws at you.',
    price: 149.99, originalPrice: 200.00, category: 'Men', subCategory: 'Streetwear',
    images: ['$_u/photo-1548036328-c9fa89d128fa?w=800&q=80', '$_u/photo-1542272604-787c3835535d?w=800&q=80'],
  ...
  Product(
    ...
    description: 'A stunning floral midi dress featuring a V-neckline, flowy silhouette, and delicate floral print. Crafted from lightweight viscose fabric that drapes beautifully. Perfect for any occasion from brunch to evening events.',
    price: 129.99, originalPrice: 180.00, category: 'Women', subCategory: 'Casual',
    images: ['$_u/photo-1572804013309-59a88b7e92f1?w=800&q=80', '$_u/photo-1585914924626-15adac1e6402?w=800&q=80', '$_u/photo-1548624313-0396a55b39f8?w=800&q=80'],
  ...
  Product(
    ...
    description: 'A sophisticated power-dressing piece that commands attention. This tailored blazer dress features peak lapels, a defined waist, and a thigh-length hemline. Made from premium Italian fabric with a subtle sheen.',
  ...
  Product(
    ...
    description: 'A modern take on the classic wide-leg silhouette. Features a high-waist design, raw hem, and premium stretch denim that flatters every body type. A true wardrobe essential that transitions from casual to smart effortlessly.',
    price: 109.99, category: 'Women', subCategory: 'Casual',
    images: ['$_u/photo-1541099649105-f69ad21f3246?w=800&q=80', '$_u/photo-1484327973588-c31f829103fe?w=800&q=80'],
  ...
  Product(
    ...
    description: 'The definitive statement piece. This cropped moto jacket is crafted from premium vegan leather with silver-tone hardware, asymmetric zip closure, and a figure-flattering fit. Instantly elevates any outfit.',
    price: 299.99, originalPrice: 450.00, category: 'Women', subCategory: 'Streetwear',
    images: ['$_u/photo-1551028719-00167b16eac5?w=800&q=80', '$_u/photo-1584464491033-06628f3a6b7b?w=800&q=80'],
  ...
  Product(
    ...
    description: 'Effortlessly chic satin slip dress that works for any occasion. Features adjustable spaghetti straps, a bias-cut silhouette that skims the body beautifully, and a delicate lace trim at the neckline. Comes in an array of luxurious colorways.',
    price: 99.99, originalPrice: 150.00, category: 'Women', subCategory: 'Formal',
    images: ['$_u/photo-1566174053879-31528523f8ae?w=800&q=80', '$_u/photo-1529139574466-a303027c1d8b?w=800&q=80'],
  ...
  Product(
    ...
    description: 'Super cute and durable denim overalls for active kids. Features adjustable straps, multiple pockets, and reinforced knees. Made from soft, pre-washed denim that moves and breathes with your little one all day long.',
    price: 49.99, originalPrice: 70.00, category: 'Kids', subCategory: 'Casual',
    images: ['$_u/photo-1622290291468-a28f7a7dc6a8?w=800&q=80', '$_u/photo-1583743814966-8936f5b7be1a?w=800&q=80'],
  ...
  Product(
    ...
    description: 'Fun graphic tee and matching shorts set for active kids. Made from super-soft 100% cotton jersey. Features playful prints and an elastic waistband for easy dressing. Available in multiple colorful options.',
    price: 39.99, category: 'Kids', subCategory: 'Casual',
    images: ['$_u/photo-1503944583220-79d8926ad5e2?w=800&q=80', '$_u/photo-1471286174890-9c112ffca5b4?w=800&q=80'],
  ...
  Product(
    ...
    description: 'A spacious and elegant leather tote that combines functionality with luxury. Made from full-grain leather with gold-tone hardware, interior organization pockets, and a detachable pouch. The perfect everyday companion.',
    price: 189.99, originalPrice: 280.00, category: 'Accessories', subCategory: 'Bags',
    images: ['$_u/photo-1548036328-c9fa89d128fa?w=800&q=80', '$_u/photo-1553062407-98eeb64c6a62?w=800&q=80'],
  ...
  Product(
    ...
    description: 'Luxuriously soft merino wool scarf with a classic ribbed pattern. Extra-long length allows for multiple styling options. A timeless accessory that adds instant sophistication to any cold-weather outfit.',
...
final kCategories = <CategoryData>[
  CategoryData(id:'men',   name:'Men',        imageUrl:'$_u/photo-1617127365659-c47fa864d8bc?w=400&q=80', emoji:'👔', color:C.primary),
  CategoryData(id:'women', name:'Women',      imageUrl:'$_u/photo-1515886657613-9f3515b0c78f?w=400&q=80', emoji:'👗', color:C.secondary),
  CategoryData(id:'kids',  name:'Kids',       imageUrl:'$_u/photo-1622290291468-a28f7a7dc6a8?w=400&q=80', emoji:'🎒', color:C.success),
  CategoryData(id:'accs',  name:'Accessories',imageUrl:'$_u/photo-1548036328-c9fa89d128fa?w=400&q=80', emoji:'👜', color:C.warning),
];

const kRackMap = <String, List<String>>{
  'rack_men_formal':   ['p01','p02'],
  'rack_men_casual':   ['p03'],
  'rack_streetwear':   ['p04','p05','p09'],
  'rack_women_casual': ['p06','p08'],
